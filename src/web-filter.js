 ...
 */
    ...
    if (win.XMLHttpRequest) {
        ...
        Object.defineProperty(win.XMLHttpRequest.prototype, metaFieldName, {
            configurable: false,
            enumerable: false,
            writable: true,
            value: undefined
        ...
        ["status", "responseText", "readyState", "statusText", "responseURL", "responseXML"].forEach(function (field) {
            var descriptor = Object.getOwnPropertyDescriptor(win.XMLHttpRequest.prototype, field);
            ...
            if (getter) {
                ...
                Object.defineProperty(win.XMLHttpRequest.prototype, field, descriptor);
            }
        });
        ...
        win.XMLHttpRequest.prototype.constructor = win.XMLHttpRequest;
        /** 结束 XHR */
    }
    /** 开始 fetch */
    if (win.fetch) {
    ...
    if (win.document && win.document.createElement) {
        ...
        win.document.createElement = function createElement(tagName) {
